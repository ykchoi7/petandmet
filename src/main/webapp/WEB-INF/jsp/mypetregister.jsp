    ...
    <section class="inner-page">
        <div class="container pet" style="text-align:center; ">
            ...
            <script>
                ...
                const dogBreeds = ['기타A/믹스견 (5kg 이하)','기타B/믹스견 (5kg 초과 12kg 미만)','노리치테리어','노르포크테리어','말티즈', '래브라도 리트리버', '불독', '시바견', '닥스훈트', '보더콜리','댄디딘몬테리어','라사압소','레이크랜드테리어','미니어처닥스훈트','미니어처볼테리어','미니어처슈나우저','미니어처푸들','미니어처핀셔','바센지','베들링턴테리어','보스턴테리어','볼로그네제','비글','비숑프리제','셔틀랜드쉽독','스코티시테리어','스코티쉬폴드','스핑크스','시베리안','시베리안숲','싱가푸라','씸릭(킴릭)','아메리칸밥테일','아메리칸와이어헤어','아메리칸컬','아비시니안','엑조틱숏헤어','오리엔탈숏헤어','오리엔탈롱헤어','오스트레일리안미스트','오시캣','쿠릴리안밥테일','쿠릴리안밥테일롱헤어','타이캣','터키쉬반','터키쉬앙고라','토이거','통키니즈','티파니'];
